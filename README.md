...
* [allong.es](http://allong.es/) - A JavaScript library based on the function combinator and decorator recipes introduced in the book [JavaScript Allongé](https://leanpub.com/javascript-allonge/read).
